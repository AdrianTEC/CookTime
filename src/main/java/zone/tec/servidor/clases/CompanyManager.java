...
public class CompanyManager {
    ...
    public CompanyManager(ServletContext x)
    {
 ...
 */
   ...
   @returns: JSONObject
 */
    public JSONObject giveMeCompany(String id){
        JSONObject company= new JSONObject();
        for (Object i: array){

            company= (JSONObject) i;
...
*/
    public void refreshArray()
    {
        ...
        try {
            ...
            datafile = new File(context.getRealPath("WEB-INF/companies.text"));
            JSONObject jsonObject = (JSONObject) parser.parse(new FileReader(datafile));
            array = (JSONArray) jsonObject.get("Empresas");
