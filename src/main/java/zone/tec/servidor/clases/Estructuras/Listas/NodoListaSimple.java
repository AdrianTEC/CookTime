 ...
 */
public  class NodoListaSimple<T> extends NodoLista<T> {

    protected NodoLista<T> next;
     ...
     */
    @Override
    public NodoLista<T> getPrevious() {
     ...
     */
    @Override
    public void setPrevious(NodoLista<T> previous) {
        System.out.println("SinglyNode doesn't have previous reference");
    }
